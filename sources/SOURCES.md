...
1) Core Option Pricing Theory (Primary Literature + Standard Texts)
	...
	•	Heston, S. (1993), A Closed-Form Solution for Options with Stochastic Volatility…: https://econpapers.repec.org/article/ouprfinst/v_3a6_3ay_3a1993_3ai_3a2_3ap_3a327-43.htm
	•	Hull, J. C., Options, Futures, and Other Derivatives (book)
	•	Shreve, S. E., Stochastic Calculus for Finance II (book)
	•	Björk, T., Arbitrage Theory in Continuous Time (book)
...
3) Binomial Tree / Replication
	...
	•	QuantStart binomial trees (multi-step): https://www.quantstart.com/articles/Pricing-a-Call-Option-with-Multi-Step-Binomial-Trees/
	•	QuantStart binomial trees (two time-step): https://www.quantstart.com/articles/Pricing-a-Call-Option-with-Two-Time-Step-Binomial-Trees/
...
5) PDE Finite Differences
	...
	•	QuantStart finite-difference Black–Scholes (Explicit Euler): https://www.quantstart.com/articles/C-Explicit-Euler-Finite-Difference-Method-for-Black-Scholes/
	•	Crank–Nicolson method: https://en.wikipedia.org/wiki/Crank%E2%80%93Nicolson_method

6) Stochastic Volatility / Model Risk
	•	Heston (1993): https://econpapers.repec.org/article/ouprfinst/v_3a6_3ay_3a1993_3ai_3a2_3ap_3a327-43.htm
...
7) FX Options (Garman–Kohlhagen)
	•	Garman, M. & Kohlhagen, S. (1983), Foreign currency option values (ScienceDirect): https://www.sciencedirect.com/science/article/pii/S0261560683800011
	•	EconPapers entry (same paper): https://econpapers.repec.org/RePEc:eee:jimfin:v:2:y:1983:i:3:p:231-237
	...
	•	GK overview (Macroption): https://www.macroption.com/foreign-currency-option-values-garman-kohlhagen/
	•	FX put-call parity / discounting summary (QuantPie): https://quantpie.co.uk/bsm_formula/bs_summary.php

8) Hedging, Transaction Costs, and Hedging Error
	•	Leland (1985) entry (RePEc): https://ideas.repec.org/a/bla/jfinan/v40y1985i5p1283-1301.html
	•	Lecture-style overview (Harvey/Gray, Duke): https://people.duke.edu/~charvey/Classes/ba350_1997/options/options.htm
...
9) Risk Metrics (Drawdown, VaR, CVaR)
	...
	•	Return and volatility basics: https://www.investopedia.com/terms/v/volatility.asp
...
12) Practical Tutorials / Blogs / Walkthroughs
	...
	•	QuantPie (finance formulas / notes): https://quantpie.co.uk/
	•	Hilpisch resources: https://hilpisch.com/
